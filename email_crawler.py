...
class EmailCrawler:
 ...
 # Credit
    # This script is enhanced and maintained with contributions from Dr. Nambili Samuel
    # Follow Dr. Nambili Samuel on LinkedIn: https://www.linkedin.com/in/nambilisamuel/
    ...
    def parse_url(self, current_url: str):
        ...
        # example --> /about.html--> https://www.gau.edu.tr/
...
print('WELCOME TO EMAIL CRAWLER 2025')
try:
    website = sys.argv[1]
except:
